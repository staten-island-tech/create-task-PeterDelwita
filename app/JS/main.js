...
// Bettinghistory function: clear card container, use filter to select certain cards (maybe use a function), use forEach to add cards to the screen (bets are stored as objects)
